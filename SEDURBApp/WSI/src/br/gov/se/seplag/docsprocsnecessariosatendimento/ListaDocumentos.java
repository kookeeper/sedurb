 ...
 *       &lt;sequence>
 *         &lt;element name="documento" type="{http://www.seplag.se.gov.br/EBO/v1}DocumentoNecessarioAtendimento" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListaDocumentos {
    ...
    protected List<DocumentoNecessarioAtendimento> documento;
     ...
     * 
     */
    public List<DocumentoNecessarioAtendimento> getDocumento() {
        if (documento == null) {
            documento = new ArrayList<DocumentoNecessarioAtendimento>();
        }
